<template>
  <div :class="['wrapper', classes]">
	...
	<span class="logo-mini">
		<a href="/"><img src="/static/img/logok2.svg" alt="Logo" class="img-responsive center-block logo"></a>
	</span>
      <!-- Header Navbar -->
      <nav class="navbar navbar-static-top" role="navigation">
        ...
        <div class="navbar-custom-menu">
          <ul class="nav navbar-nav">
            ...
            <!-- Logout Button -->
            <li class="dropdown user user-menu">
              <a href="javascript:;" v-on:click="logout" title="Logout" >
    ...
    <footer class="main-footer">
      <strong>Copyright &copy; {{year}}
        <a href="javascript:;">Kommuninvest</a>.</strong> All rights reserved.
    </footer>
  </div>
  <!-- ./wrapper -->
</template>
...
export default {
  ...
  computed: {
    ...
    demo () {
      return {
        displayName: (this.$store.state.user) ? this.$store.state.user.fullname + ' - ' + this.$store.state.user.organization_id : null,
